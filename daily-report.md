...
**Tarih:** 2026-07-26 UTC (Test çalışma zamanı: 2026-07-25T09:47 UTC)
...
- **Build:** https://github.com/aydinserbest/claude-routines/actions/runs/30153330328

### Olasi Sebep Tahmini

**Selector yanlis — site veya ag sorunu degil.** Diger iki test (`should load successfully`, `should have a heading`) tum tarayicilarda basariyla gectigi icin site erisilebilir durumda. `button#login` ID'li element sayfada bulunmuyor; ya hic eklenmemis ya da ID degismis. Bu hata her gun tekrarlanmaktadir.
